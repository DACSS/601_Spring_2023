...
I used the railroads data set from 2012. Here's what I found!

```{r}
#creating the data set while also practicing permanently changing one of the variable names at the top
...
```{r}
#the df summary for all the individual data sets
