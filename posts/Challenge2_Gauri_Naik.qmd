...
library(tidyverse)
  hotel <- read.csv("C:/Users/naiga/Documents/GithubDACSS601/601_Spring_2023/posts/_data/hotel_bookings.csv")
...
print(h2)
```
Due to the amount of data we have available, Quarto takes a long time to load if we try to create a customized table. We still have a lot of data, but at least it's manageable now. We also have a new column where we can check whether or not the reserved room type was the type assigned to the booking when checked in.
