...
```{r}
tempdf = subset(df, select = c(location_key, cumulative_deceased_per_capita, older_per_capita, smoking_prevalence, cumulative_persons_fully_vaccinated_per_capita, human_development_index) )
tempdf <- tempdf %>% 
