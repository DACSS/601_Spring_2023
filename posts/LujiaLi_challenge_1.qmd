...
title: "Challenge 1"
author: "Lujia Li"
desription: "to complete challege 1"
date: "03/22/2023"
format:
  html:
    toc: true
...
```{r}
read_csv("/Users/lujiali/Desktop/BRFSS.csv")
read_csv("/Users/lujiali/Desktop/BRFSS.csv", skip = 3)
  select(Year)%>%
  n_distinct(.)
```

```{r}
mydata2<-read_csv("/Users/lujiali/Desktop/BRFSS.csv")
