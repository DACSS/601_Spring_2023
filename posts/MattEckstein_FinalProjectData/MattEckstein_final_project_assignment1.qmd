...
library(readxl)
birds <- read_xlsx("posts/MattEckstein_FinalProjectData/PopEsts_ProvState_2021.02.05.xlsx")
str(birds)
...
states <- read_csv("posts/MattEckstein_FinalProjectData/State_statistics.csv")
