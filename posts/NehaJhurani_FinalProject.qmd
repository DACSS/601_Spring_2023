...
The Lancet published a significant global study on the causes of disease and mortality called The Global Burden of Disease. The annual number of deaths dataset's estimates are displayed here.

The datasaet describes the causes of death of all people in the world from the year 1990 to 2019. The data was collected from https://ourworldindata.org/causes-of-death and was uploaded in Kaggle. 

The data represents the annual number of people that died of a particular disease or cause in different years.
...
```{r}
library(readr)
death_dataset <- read_csv("NehaJhurani_FinalProjectData/20222703CausesOfDeath.csv")
