...
gender again and looks at smokers vs. non-smokers sleep efficiency. The
firm horizontal line shows the mean overall, while the fluid, curved
line shows the mean sleep efficiency for non-smokers on the left side
and the mean efficiency for smokers on the right side. They all show
decreasing trends.
