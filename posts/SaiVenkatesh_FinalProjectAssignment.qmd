...
As variable separated by dots are difficult to read it was concluded to use underscore separated naming convention.
...
The table below provides the summary of the dependant variable, Satisfaction and the other independent variables.
...
As the problem statement requires interpretation of individual predictor variables, adding or deleting variables will play an important factor in dealing with a troublesome variable.

This data set has quite a good information for the first level analysis and visualization.
There is no need to add or delete any variable.
