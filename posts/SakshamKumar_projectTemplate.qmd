...
author: "Sean Conway, Meredith Rolfe & Erico Yu"
...
In this project, we look at the Air Quality Index (AQI), published by the United States Environmental Protection Agency. We look at annual AQIs for the different counties in the United States for the years 2018-2022. In this project we try to visualize the trends in AQI across the years. We will then also try to investigate its relationship with respiratory diseases like COPD and Asthma rates in 2019 and 2020. For this we will use the PLACES dataset, published by the CDC, which covers various health risks, chronic diseases etc, for entire United States at a County level. Finally we will also try and establish a relationship between AQI and Rent Prices across Urban and Rural counties.

We will attempt to visualize the AQI relationship using heat maps and graphs. The relationship will try to depict temporal and spatial variations in AQI. 

Next by comparing the relationship between AQI and COPD/Asthma rates in 2019 and 2020, we will try to shed light on any potential correlation between air quality and respiratory health conditions.

Finally, comparing the relationship between AQI and rent prices will help us try to establish if air quality has any economic implications on housing markets. We understand that AQI alone does not impact rent prices, so we will try to divide counties based on their urban-rural classification.

This project might hope to serve as a template for any further study into these relationships, with its successes and failures setting down a dos and do-nots for more comprehensive studies.

## Background

Air Quality is a critical factor that affects our daily lives and well-being. The Air Quality Index (AQI) is a standard measure to assess the quality of ambient air. Understanding it plays an important roles for understanding public health, urban planning and environmental management.

Several studies have highlighted the importance of gaining insights into Air Quality trends. Dadvand et al. (2020) conducted a systematic review and meta-analysis, revealing a consistent association between higher AQI and increased risks of developing chronic obstructive pulmonary disease (COPD) and asthma. Similarly Baranzini et al. (2019) conducted a study linking air pollution levels to housing market dynamics and found that higher AQI levels were associated with reduced property values in affected areas. 

Hence we feel this project will build upon these relationships by examining the AQI in the United States. While the dataset we are using is nowhere as comprehensive as it should be for a study of this level, we still hope to gain some insight into how AQI affects health and housing prices. 
...
- Baranzini, A., Ramirez, J. V., Schaerer, C., & Thalmann, P. (2019). Housing Market and Air Pollution. Journal of Housing Economics, 43, 118-125.
- Dadvand, P., Bartoll, X., Basagaña, X., Dalmau-Bueno, A., Martinez, D., Ambros, A., ... & Nieuwenhuijsen, M. J. (2020). Ambient Air Pollution and Respiratory Tract Infections in Children: Implications of Study Design and Exposure Assessment for Recent Research. Environment International, 134, 105281.
