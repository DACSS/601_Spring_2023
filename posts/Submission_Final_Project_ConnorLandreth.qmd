...
```{r Index}
data.frame(data.frame, stringsAsFactors = TRUE)
...
::: {#AllOtherVariables .panel-tabset}
...
gender again and looks at smokers vs. non-smokers sleep efficiency.
