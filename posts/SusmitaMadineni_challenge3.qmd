...
As expected, we can observe that the pivoted dataset has 480 observations with 5 columns(month, year, size, quantity and price of the eggs). This helps us to easily analyze the data. 
