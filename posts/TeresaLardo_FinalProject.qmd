...
region_time_series <- ggplot(bfro %>%
  ...
  geom_line() + 
  xlab("Year") + 
  ylab("Number of Bigfoot Reports") 

region_time_series <- ggplotly(region_time_series)
