...
2.  **Please make the following changes to the above YAML header:**
    ...
    DONE -   Change the "title" to "Final Project Assignment#1: First Name Last Name";

    DONE -   Change the "author" to your name;

    DONE -   Change the "date" to the current date in the "MM-DD-YYYY" format;
...
my_packages <- c("tidyverse", "pdftools", "knitr", "ggplot2") # create vector of packages
...
```{r}
txt <- pdf_text("../posts/TimShores_FinalProject_Data/02Leverett2018.pdf")
