...
```{r chunkByReason1, fig.width=10, fig.height=10}
...
quantileBoundary = 0.9
  # we only want reasons with the most total call hours,
  # choosing upper hinge as lower boundary for maximum mathiness
...
# rm(testtest, topfactors)
# this uses topfactors to remove all but the reasons with the most total call hours
# then graph only the call reasons with total hours above 75th percentile
callReasonsDF %>%
