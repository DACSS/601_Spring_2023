...
crYeargrowthLM <- round(lm(callTotalHours ~ year(year), data = crYearDF)$coefficients[2], 1)
...
crLevgrowthLM <- round(lm(callTotalHours ~ year(year), 
                          data = filter(crTownYearDF, 
                                        town == "Leverett")
                          )$coefficients[2], 1)
crWengrowthLM <- round(lm(callTotalHours ~ year(year), 
                          data = filter(crTownYearDF, 
                                        town == "Wendell")
                          )$coefficients[2], 1)
