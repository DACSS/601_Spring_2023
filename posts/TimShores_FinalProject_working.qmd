...
Zoom in on call reasons with the most hours
...
topfactors <- callReasonsDF %>%
  ...
  # first we want the top 50 reasons with the most total call hours
...
# this uses top50factors to target factors for removal
...
callReasonsDF %>%
  ...
  labs(title = "Top level-of-effort call reasons",
        subtitle = "Total hours 2018-2022, top 30 call reasons",
        x = "Hours",
        y = "Reasons") +
  #scale_fill_viridis(discrete = T, option = "cividis") +
  theme_ipsum() 
