...
my_packages <- c("tidyverse", "fs", "pdftools", "knitr", "ggplot2", "viridis", "hrbrthemes") # create vector of packages
...
Three key metrics are the number of calls (call volume), average hours worked, and total hours worked. These metrics can broken down further by factors town, year, call reason, and call theme.
