...
Using the same analysis, this table summarizes **Total hours by town** growth rates that correspond to the orange trend lines in these plots: 

```{r chunkByTownGrowthSummary, fig.width=10, fig.height=4}
crtyGrowthDF
```

This reveals that Wendell drives the growth in calls by a factor of around 20 to 1 compared with Leverett.
...
```{r chunkByTheme, fig.width=10, fig.height=10}
