...
```{r}
dfPubSchoolSub <- subset(dfPubSchool, select = c(NMCNTY, PK, KG, G01, G02, G03, G04, G05, G06, G07, G08, G09, G10, G11, G12, G13, TOTAL, FTE, SCHOOL_TYPE_TEXT, SY_STATUS_TEXT, SCHOOL_LEVEL))

dfPubSchoolSub$SCHOOL_TYPE_TEXT <- as.factor(dfPubSchoolSub$SCHOOL_TYPE_TEXT)
dfPubSchoolSub$SCHOOL_TYPE_TEXT <- as.factor(dfPubSchoolSub$SCHOOL_TYPE_TEXT)
dfPubSchoolSub$SCHOOL_TYPE_TEXT <- as.factor(dfPubSchoolSub$SCHOOL_TYPE_TEXT)
class(dfPubSchoolSub$SCHOOL_TYPE_TEXT) 
