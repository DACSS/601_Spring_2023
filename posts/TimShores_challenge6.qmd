...
By separating out Market Segments (which I mutated to a factor a few code blocks ago), we begin to see the proportion of mean ADR attributed to each segment, how that segment changes over time, and when segments go against the annual pattern -- such as the apparent absence of the Aviation Segment before 2016.
