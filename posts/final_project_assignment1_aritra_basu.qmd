...
Github was not allowing me to commit file sizes more than 100 MB. I have shown all the steps, but I have only saved the final file in the folder and have removed the rest. 

```{r}
# my_data <- read_csv("AritraBasu_FinalProjectData/atusresp_0320.dat")
# my_data2 <- read_csv("AritraBasu_FinalProjectData/atuscps_0320.dat")
# filtered_my_data2 <- my_data2 %>%
#  filter(TULINENO == 1)
# merged_data12 <- left_join(my_data, filtered_my_data2, by = c("TUCASEID"))
# my_data3 <- read_csv("AritraBasu_FinalProjectData/atussum_0320.dat")
