...
```{r}
getwd()
income_data <- read_excel("/Users/rahulsomu/Documents/DACSS_601/601_repo/posts/Rahul_Final_projectData/income_state.xlsx")

df_inflation <- read_excel("/Users/rahulsomu/Documents/DACSS_601/601_repo/posts/Rahul_Final_projectData/USA_inflation_data.xlsx")

df_rentalindex <- read.csv("/Users/rahulsomu/Documents/DACSS_601/601_repo/posts/Rahul_Final_projectData/ZHVI.csv")
...
Plot 5 displays the standard error distribution, which shows how accurate the estimates of median income are. We can analyze the quality of the data by using the histogram to understand the distribution and concentration of standard error values.

```{r}
plot5 <- ggplot(result_df, aes(x = Standard_Error, fill = State)) +
  geom_histogram(binwidth = 5) +
  labs(x = "Standard Error", y = "Count", title = "Standard Error Distribution") +
  theme_bw()
