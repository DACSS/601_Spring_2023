...
## Background of the topic (Optional - In progress or to DELETE) (#background-tipic)

In a general context, swimming is an excellent recreational activity and
enjoyed by people of all ages. In a competitive context, swimming
provides the additional benefits of setting goals, sportsmanship and
team involvement. From backstroke to breaststroke and butterfly to
freestyle, swimmers delight in the variety of swimming strokes to
challenge, motivate and entertain them in the supportive medium of
water, while simultaneously, set new world records year after year. This
requires years of commitment, training, and discipline. =\> However, Are
these the only factors that we can attribute to set new world records?
or Are there any patterns, trends, relationships or other possible
explanation that let us understand what make them set new world records.
